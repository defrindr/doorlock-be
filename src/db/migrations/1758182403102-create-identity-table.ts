  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "account_guests" (
        ...
        "visit_date" date,
        "valid_until" date,
        "host_employee_id" uniqueidentifier,
    ...
    // Add self-referencing foreign keys for supervisors
    await queryRunner.query(
      `ALTER TABLE "account_employees" ADD CONSTRAINT "FK_account_employees_supervisor_id" FOREIGN KEY ("supervisor_id") REFERENCES "account_employees"("id") ON DELETE SET NULL ON UPDATE CASCADE`,
    );

    await queryRunner.query(
      `ALTER TABLE "account_interns" ADD CONSTRAINT "FK_account_interns_supervisor_id" FOREIGN KEY ("supervisor_id") REFERENCES "account_employees"("id") ON DELETE SET NULL ON UPDATE CASCADE`,
    );

    await queryRunner.query(
      `ALTER TABLE "account_guests" ADD CONSTRAINT "FK_account_guests_host_employee_id" FOREIGN KEY ("host_employee_id") REFERENCES "account_employees"("id") ON DELETE SET NULL ON UPDATE CASCADE`,
    );
